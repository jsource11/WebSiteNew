                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Nuevo Post - Blog </h4>
                            ...
                            <form method="post" action="{{ route('store.blog.post') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="post_tags" value="linux,open-source" class="form-control" type="text" data-role="tagsinput"> 
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Insert Post Data">
