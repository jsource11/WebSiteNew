                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('edit.blog.post',$post->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="post_category_id" class="form-select" aria-label="Default select example">
                                            <option selected="">-- Seleccionar -- </option>
                                            @foreach ($categories as $item )
                                                <option value="{{ $item->id }}" {{$item->id == $post->category_id ? 'selected':''}}>{{ $item->blog_category }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="elm1" name="post_description">
                                            {{ $post->description }}
                                        </textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-lg" src="{{ asset($post->image) }}" alt="Card image cap">
                                    </div>
                                </div>
                                <!-- end row -->

                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Update Post Data">
